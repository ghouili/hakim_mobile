...
const DetailsReclamation = ({ route, navigation }) => {
    ...
    <SafeAreaView style={{flex: 1}}>
        ...
        <ScrollView>
            ...
            <Card style={{width: '90%', paddingTop: 10, marginTop: 10, marginHorizontal: '5%', paddingBottom: 10, marginBottom: 20 }}>
                ...
                <Text style={{fontSize: 30, alignSelf: 'center', fontWeight: '700', color: '#071689'}} >{data.product}</Text>
                ...
                <View style={{width: '100%', paddingHorizontal: '4%', marginTop: 5 }}>
                    <Text style={{fontSize: 20}} >{data.nbr} Peace</Text>
                </View>
